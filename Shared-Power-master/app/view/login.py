...
class Login(tk.Frame):
    ...
    def __init__(self, root):
        ...
        self.welcome_label = Label(self, text="Welcome to\nShared Power!", font=('Helvetica', 15))\
            .grid(row=0, column=0, columnspan=2, pady=5)
        self.email_label = Label(self, text="Email").grid(row=1, column=0, pady=5)
        self.password_label = Label(self, text="Password").grid(row=2, column=0, pady=5)
        ...
        self.login_button = Button(self, text="Login", command=self.check_credentials)\
