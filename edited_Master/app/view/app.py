...
from app.view.content_frames.owner_tools import ManageTools
from app.view.content_frames.customer_tools import Tools
...
class App(tk.Frame):
    ...
    def go_back(self, previous_frame):
        function_mapping = {"Basket": Basket, "Bookings": Bookings, "CreateTool": CreateTool,
                            "Invoices": Invoices, "ManageTools": ManageTools, "Tools": Tools,
                            "View_Profile": View_Profile, "Welcome": Welcome}
        frame_function = function_mapping.get(previous_frame)
        self.switch_frame(frame_function(self, user_id=self.USER.id))
